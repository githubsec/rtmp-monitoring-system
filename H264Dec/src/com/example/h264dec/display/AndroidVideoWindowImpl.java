...
public class AndroidVideoWindowImpl {
	...
	public void init() {
		...
		/*if (mVideoPreviewView != null) {
			mVideoPreviewView.getHolder().addCallback(new Callback(){
				public void surfaceChanged(SurfaceHolder holder, int format,
						int width, int height) {
					Log.i("GLES","Video preview surface is being changed.");
					if (mListener!=null) 
						mListener.onVideoPreviewSurfaceReady(AndroidVideoWindowImpl.this, mVideoPreviewView);
					Log.w("GLES","Video preview surface changed");
				}
				...
				public void surfaceDestroyed(SurfaceHolder holder) {
					...
					Log.d("GLES","Video preview surface destroyed"); 
				}
			});
		}*/
	...
	public Surface getSurface(){
		if (useGLrendering)
			Log.e("GLES","View class does not match Video display filter used (you must use a non-GL View)");
	...
	public void setOpenGLESDisplay(int ptr) {
		if (!useGLrendering)
			Log.e("GLES","View class does not match Video display filter used (you must use a GL View)");
